...
.st-key-shared_output_card:has([data-testid="stSpinner"]) .predicted-output-card,
.st-key-mine_output_card:has([data-testid="stSpinner"]) .predicted-output-card {
    opacity: 0.25 !important;
    filter: grayscale(0.8);
    transition: opacity 0.15s ease-out, filter 0.15s ease-out;
}
.st-key-shared_output_card .predicted-output-card,
.st-key-mine_output_card .predicted-output-card {
    transition: opacity 0.15s ease-out, filter 0.15s ease-out;
}
