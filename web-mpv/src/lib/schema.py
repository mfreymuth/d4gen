...
# Acceptance ranges for a "good" LNP formulation. Predicted outputs inside
# their target range are visually marked OK (green), outside marked BAD (red).
OUTPUT_TARGETS: dict[str, tuple[float, float]] = {
    "size_nm": (80.0, 110.0),
    "pdi": (0.0, 0.2),
    "encaps_pct": (85.0, 100.0),
    "zeta_mv": (-10.0, 10.0),
}
